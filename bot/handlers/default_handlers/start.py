...
def bot_start(message: Message):
    bot.reply_to(message, f"{message.from_user.full_name}!\n"
                          ...
                          f"Пользователь привязан к ID TELEGRAM: {message.from_user.id}"
                          f"Используя сервис, вы разрешаете использовать ваши персональные данные для обработки запросов и хранение ваших привычек.")
