...
def update_habit(json_data: dict, token: str):
    ...
    response = requests.patch('http://fastapi:8000/api/v1/jwt/habit/update', headers=headers_update, json=json_data)
    print('update_habit status code >>>> ', response.status_code)
    return response
